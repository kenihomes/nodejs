...
const makeList = (user) => {
  ...
  <div class="row">
    ...
    <div class="form-group col-1 ">
        <input type="text" class="form-control" placeholder="roole" id="${user.id}role" value="${user.role}" disabled>
    ...
    <div class="form-group col-1" id="${user.id}editDiv">
        <button class="btn btn-primary" id="${user.id}edit" onclick="editName(this.id)">
            Edit
        </button>
    </div>
    <div class="form-group col-1" style="display:none" id ="${user.id}updateDiv">
        <button class="btn btn-primary" id="${user.id}update" onclick="updateUserData(this.id)">
            update
        </button>
    </div>
    <div class="form-group col-1">
        <button class="btn btn-danger" id="${user.id}delete" onclick="deleteName(this.id)">
            Delete
        </button>
    </div>
    </div>
